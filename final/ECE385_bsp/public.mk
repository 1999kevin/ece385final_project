...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9b58
SOPC_SYSID_FLAG += --sidp=0x9b58
ELF_PATCH_FLAG  += --sidp 0x9b58
...
# setting hal.stderr is nios2_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev nios2_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is nios2_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev nios2_jtag_uart
...
# setting hal.stdout is nios2_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev nios2_jtag_uart

...
# Memory: usb_keycode
MEM_0 := ECE385_usb_keycode
$(MEM_0)_NAME := usb_keycode
...
$(MEM_0)_START := 0x00000c00
$(MEM_0)_END := 0x00000fff
$(MEM_0)_SPAN := 0x00000400
$(MEM_0)_HIERARCHICAL_PATH := usb_keycode
$(MEM_0)_WIDTH := 32
...
.PHONY: usb_keycode
usb_keycode: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: usb_nios2_onchip_mem
MEM_1 := ECE385_usb
$(MEM_1)_NAME := usb_nios2_onchip_mem
...
$(MEM_1)_END := 0x00013fff
$(MEM_1)_SPAN := 0x00004000
$(MEM_1)_HIERARCHICAL_PATH := usb_nios2_onchip_mem
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: usb_nios2_onchip_mem
usb_nios2_onchip_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
